...
namespace Nom.TypeChecker
{
    public class LambdaTransformEnvironment : ICodeTransformEnvironment
    {
        ...
        public IOptional<ICallableReference> GetInstance(IParamRef<IClassSpec, Language.IType> cls, IEnumerable<Language.IType> argTypes)
        {
            return ParentEnv.GetInstance(cls, argTypes);
        }
