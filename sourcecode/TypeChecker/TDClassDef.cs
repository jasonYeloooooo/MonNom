...
namespace Nom.TypeChecker
{
    internal class TDClassDef : TDInterfaceDef
    {
        ...
        //add instanceDef
        private List<InstanceDef> instanceDefinitions = new List<InstanceDef>();
        public IEnumerable<InstanceDef> Instances => instanceDefinitions.ToList();
        public void AddInstanceDef(InstanceDef id)
        {
            instanceDefinitions.Add(id);
        }
    }
}
