...
namespace Nom.Parser
{
    public class StmtVisitor<Arg, Ret> : IStmtVisitor<Arg, Ret>
    {
        ...
        private Func<InstanceFieldAssignment, Arg, Ret> visitInstanceAssignStmt;
        ...
        private Func<DefaultExprStmt, Arg, Ret> visitDefaultExprStmt;
        ...
        public virtual Func<DefaultExprStmt, Arg, Ret> VisitDefaultExprStmt
        {
            get
            {
                return visitDefaultExprStmt ?? DefaultVisitor;
            }

            set
            {
                visitDefaultExprStmt = value;
            }
        }
        ...
        public Func<InstanceFieldAssignment, Arg, Ret> VisitInstanceFieldAssignment {
            get
            {
                return VisitInstanceFieldAssignment ?? DefaultVisitor;
            }

            set
            {
                visitInstanceAssignStmt = value;
            }
        }
