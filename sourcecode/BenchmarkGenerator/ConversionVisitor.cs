...
{
    public class ConversionVisitor<S> : IDefaultExprVisitor<S, IDefaultExpr>, IExprVisitor<S, Parser.IExpr>, ITypeVisitor<S, Parser.IType>, IStmtVisitor<S, Parser.IStmt>
    {
        ...
        public Func<BinOpDefaultExpr, S, IExpr> VisitBinOpDefaultExpr => throw new NotImplementedException();

        Func<BinOpDefaultExpr, S, IDefaultExpr> IDefaultExprVisitor<S, IDefaultExpr>.VisitBinOpDefaultExpr => throw new NotImplementedException();

        public Func<DefaultExprStmt, S, IStmt> VisitDefaultExprStmt => throw new NotImplementedException();

        Func<InstanceFieldAssignment, S, IStmt> IStmtVisitor<S, IStmt>.VisitInstanceFieldAssignment => throw new NotImplementedException();
    }
}
