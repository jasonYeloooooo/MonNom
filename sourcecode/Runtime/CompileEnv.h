...
namespace Nom
{
	namespace Runtime
	{
		...
		public:
			...
			virtual bool GetInConstructor() { return false; }
			virtual bool GetInInstance() { return false; }
		...
		public:
			...
			virtual llvm::Value* GetEnvTypeArgumentArray(NomBuilder& builder) override;
			virtual bool GetInConstructor() override { return false; }
			virtual bool GetInInstance() override { return false; }
		...
		//add Instance
		class InstanceCompileEnv : public AFullArityCompileEnv
		{
		private:
			bool inInstance = true;
		public:
			const NomInstance* const Method;
			InstanceCompileEnv(RegIndex regcount, const llvm::Twine contextName, llvm::Function* function, const std::vector<PhiNode*>* phiNodes, const llvm::ArrayRef<NomTypeParameterRef> directTypeArgs, const TypeList argtypes, NomClassTypeRef thisType, const NomInstance* method);
			virtual NomTypeVarValue GetTypeArgument(NomBuilder& builder, int i) override;
			virtual size_t GetEnvTypeArgumentCount() override;
			virtual llvm::Value* GetEnvTypeArgumentArray(NomBuilder& builder) override;
			virtual bool GetInInstance() override ;
			virtual bool GetInConstructor() override { return false; }
			virtual void SetPastInitialSetup();
		};
